function PointJS(Va, Wa, Xa, Sc) {
    ...
    this.system.setSmoothing = function (a) {
        Ga = a;
        h.msImageSmoothingEnabled = true;
        h.imageSmoothingEnabled = true;
        h.imageSmoothingQuality = "high";
        console.log(h.imageSmoothingQuality)
    };
    this.system.restart = function (a) {
        k.location.reload(a);
    };
    var Fc = { name: "PointJS", desc: "HTML5 Game Engine for JavaScript", author: "\u0410\u043b\u0435\u043a\u0441\u0430\u043d\u0434\u0440 \u041f\u0442\u0438\u0447\u043a\u0438\u043d (multuroki@gmail.com)", version: "0.2.0.9" };
    ...
    this.vector.moveCollision = function (a, b, c, f, d, e) {
        ...
        var n = 2 + h.x;
        for (m = 2 + h.y; 0 <= k; k--)
            if (((h = b[k]), h.visible && a !== h && !((d && !h.isInCameraStatic()) || (e && a.getDistanceC(h.getPositionC()) > e)) && a.isStaticIntersect(h.getStaticBox()))) {
    ...
    var cc = 0,
        l = {
            loaded: !1,
            events: { onload: [], preLoop: [], postLoop: [], entryLoop: [], exitLoop: [], gameBlur: [], gameFocus: [], gameResize: [], gameStop: [], gameStart: [] },
            ...
            getWH: function () {
                return { w: parseInt(k.innerWidth || k.document.body.clientWidth), h: parseInt(k.innerHeight || k.document.body.clientHeight) };
            },
        };
    ...
    q.style.position = Ea;
    K
        ? ((q.style.left = Ja.x + "px"),
          (q.style.top = Ja.y + "px"),
          l.addEvent("gameResize", "initedCanvasResize", function () {
              var a = Xb(K);
    ...
    var Y = !1,
        Ic = function () {
            Y ||
                (this.requestFullscreen ? (this.requestFullscreen(), (Y = !0)) : this.mozRequestFullScreen ? (this.mozRequestFullScreen(), (Y = !0)) : this.webkitRequestFullscreen && (this.webkitRequestFullscreen(), (Y = !0)),
                (m = l.getWH().w),
                (n = l.getWH().h),
                (H = m / 2),
                (I = n / 2),
    ...
    this.system.initFullScreen = function () {
        K ||
            Y ||
            ((k.document.documentElement.onclick = Ic),
            Ka ||
                (l.addEvent("gameResize", "PointJS_initFullScreen", function () {
                    m = l.getWH().w;
                    n = l.getWH().h;
                    H = m / 2;
                    I = n / 2;
    ...
    this.system.exitFullScreen = function () {
        Y &&
            (l.delEvent("gameResize", "PointJS_initFullScreen"),
            k.document.exitFullscreen
                ? (k.document.exitFullscreen(), (Y = !1))
                : k.document.mozCancelFullScreen
                ? (k.document.mozCancelFullScreen(), (Y = !1))
                : k.document.webkitExitFullscreen && (k.document.webkitExitFullscreen(), (Y = !1)),
            (m = na),
            (n = oa),
            (H = m / 2),
            (I = n / 2),
            ...
            (r.style.height = n + "px"),
            ta(),
            (k.document.documentElement.onclick = function () {}));
    };
    ...
    this.system.initFullScale = function (a) {
        K ||
            Ka ||
            (a && (gc = !0),
            l.addEvent("gameResize", "PointJS_initFullScale", function () {
                var a = ec,
                    c = fc,
                    f = l.getWH();
            ...
            l.runEvent("gameResize", "PointJS_initFullScale"),
            (Ka = !0));
    };
    ...
    var Hb = !1,
        ...
        Jc = { 8: !0, 9: !0, 13: !0, 18: !0, 16: !0, 17: !0, 27: !0, 112: !0, 113: !0, 114: !0, 115: !0, 116: !0, 117: !0, 118: !0, 119: !0, 120: !0, 121: !0, 122: !0, 123: !0 };
    ...
    var Pa = !0,
        ...
        va = e(0, 0),
        gb = !1,
        Ib = { LEFT: 1, RIGHT: 3, MIDDLE: 2 },
        Jb = { 1: "LEFT", 3: "RIGHT", 2: "MIDDLE" },
        hb = !1,
        ib = {},
        jb = {},
        Qa = {},
    ...
    var pc = function () {
        ...
        sc = function () {
            P.audio &&
                v(P.audio, function (a) {
                    a.stop();
                });
        };
    this.game.newLoop = function (a, b, c, f, d) {
        "function" === typeof b ? (ka[a] = { events: d || !1, func: b, start: c || !1, end: f || !1, audio: !1, fps: !1, name: a }) : la("error in newLoop : " + b + " is not a function");
    };
    ...
    var Mb = function () {
            ...
            if (60 > Ta) {
                var a = 1e3 / Ta;
                try {
                    (O = Date.now()), O - oc > a && (qc(), P.func(rb), (oc = O), rc());
                } catch (b) {
    ...
    F.prototype = {
        ...
        getDynamicBox: function () {
            ...
            return 0 === this.angle
                ? [
                      e(this.x + this.box.x, this.y + this.box.y),
                      e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y),
                      e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y + this.h + this.box.h),
                      e(this.x + this.box.x, this.y + this.box.y + this.h + this.box.h),
                  ]
                : [
                      J(e(this.x + this.box.x, this.y + this.box.y), a, this.getAngle()),
                      J(e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y), a, this.getAngle()),
                      J(e(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y + this.h + this.box.h), a, this.getAngle()),
                      J(e(this.x + this.box.x, this.y + this.box.y + this.h + this.box.h), a, this.getAngle()),
                  ];
        },
        ...
        getStaticBoxPosition: function () {
            return { x: this.x + this.box.x, y: this.y + this.box.y, w: this.x + this.box.x + this.w + this.box.w, h: this.y + this.box.y + this.h + this.box.h };
        },
        getStaticBox: function (a, b, c, f) {
            return { x: this.x + this.box.x + (a || 0), y: this.y + this.box.y + (b || 0), w: this.w + this.box.w + (2 * c || 0), h: this.h + this.box.h + (2 * f || 0) };
        },
        getStaticBoxA: function (a, b, c, f) {
            return { x: this.x + this.box.x + (a || 0), y: this.y + this.box.y + 1 + (b || 0), w: this.w + this.box.w - 1 + (c || 0), h: this.h + this.box.h - 2 + (f || 0) };
        },
        getStaticBoxD: function (a, b, c, f) {
            return { x: this.x + this.box.x + 1 + (a || 0), y: this.y + this.box.y + 1 + (b || 0), w: this.w + this.box.w - 1 + (c || 0), h: this.h + this.box.h - 2 + (f || 0) };
        },
        getStaticBoxW: function (a, b, c, f) {
            return { x: this.x + this.box.x + 1 + (a || 0), y: this.y + this.box.y + (b || 0), w: this.w + this.box.w - 2 + (c || 0), h: this.h + this.box.h - 1 + (f || 0) };
        },
        ...
        getPosition: function (a) {
            return 1 === a
                ? e(this.x + (this.w / 2 + this.center.x), this.y + (this.h / 2 + this.center.y))
                : 2 === a
                ? ((a = e(this.x + this.w / 2, this.y + this.h / 2)), this.angle && (a = J(a, this.getPosition(1), this.angle)), e(a.x, a.y))
                : e(this.x, this.y);
        },
        ...
        rotateForAngle: function (a, b) {
            ...
            c >= -b - 0.5 && c <= b + 0.5 ? (this.angle = a) : c > b + 0.5 ? (this.angle -= b) : c < -b - 0.5 && (this.angle += b);
        },
        rotateForPoint: function (a, b) {
            var c = Ha(this.getPositionC(), a);
        ...
        isInCameraDynamic: function () {
            var a = this.getDynamicBox(),
                b = [e(g.x, g.y), e(g.x + m, g.y), e(g.x + m, g.y + n), e(g.x, g.y + n)],
                c,
                f = 0;
            var d = 0;
    ...
    vb.prototype.getDynamicBox = function () {
        ...
        return 0 === this.angle
            ? [e(this.x + this.w / 2, this.y), e(this.x + this.w, this.y + this.h), e(this.x, this.y + this.h)]
            : [J(e(this.x + this.w / 2, this.y), a, this.getAngle()), J(e(this.x + this.w, this.y + this.h), a, this.getAngle()), J(e(this.x, this.y + this.h), a, this.getAngle())];
    };
    vb.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            ...
            Ua(this.x, this.y, [e(this.w / 2, 0), e(this.w, this.h), e(0, this.h)], this.fillColor, this.strokeWidth ? this.strokeColor : !1, this.strokeWidth);
    ...
    ma.prototype.setRadius = function (a) {
        a &&
            ...
            (1 > a &&
                ((a = 1),
                console.log(
                    "\u0412\u043d\u0438\u043c\u0430\u043d\u0438\u0435! \u0420\u0430\u0434\u0438\u0443\u0441 \u043e\u043a\u0440\u0443\u0436\u043d\u043e\u0441\u0442\u0438 \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0440\u0430\u0432\u043d\u044f\u0442\u044c\u0441\u044f \u043d\u0443\u043b\u044e \u0438\u043b\u0438 \u0431\u044b\u0442\u044c \u043e\u0442\u0440\u0438\u0446\u0430\u0442\u0435\u043b\u044c\u043d\u044b\u043c"
                )),
            (this.radius = a),
            (this.w = 2 * a),
            (this.h = 2 * a));
        ...
        if (this.loaded) {
            ...
            for (f = 0; f < this.countY; f += 1)
                if (!(this.y + f * this.h + this.h < g.y || this.y + f * this.h > g.y + n))
                    for (c = 0; c < this.countX; c += 1) this.x + c * this.w + this.w < g.x || this.x + c * this.w > g.x + m || h.drawImage(this.cnv, a + c * this.w, b + f * this.h, this.w, this.h);
        }
    };
    ...
    ca.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            ...
            if (this.fillColor || this.strokeColor)
                this.radius ? wb(e(this.x, this.y), z(this.w, this.h), this.radius, this.fillColor, this.strokeColor, this.strokeWidth) : ba(e(this.x, this.y), z(this.w, this.h), this.fillColor, this.strokeColor, this.strokeWidth);
    ...
    U.prototype.getDynamicBox = function () {
        for (var a = [], b = this.points.length - 1; 0 <= b; b--) a.push(J(this.points[b], e(this.w / 2 + this.center.x, this.h / 2 + this.center.y), this.angle).plus(e(this.x, this.y)));
        return a;
    };
    ...
    R.prototype.drawFrame = function (a) {
        if (this.visible && this.alpha) {
            var b = !1;
            if (this.angle || 1 !== this.alpha || this.flip.x || this.flip.y || this.shadowColor) T(this), (b = !0);
    ...
    var nc = function (a) {
            var b = !1;
            "RectObject" === a.type
                ? (b = A.game.newRectObject({}))
                : "CircleObject" === a.type
                ? (b = A.game.newCircleObject({}))
                : "RoundRectObject" === a.type
                ? (b = A.game.newRoundRectObject({}))
                : "TextObject" === a.type
                ? (b = A.game.newTextObject({}))
                : "EllipsObject" === a.type
                ? (b = A.game.newEllipsObject({}))
                : "ImageObject" === a.type
                ? (b = A.game.newImageObject({ file: a.file }))
                : "TriangleObject" === a.type
                ? (b = A.game.newTriangleObject({}))
                : "PolygonObject" === a.type
                ? (b = A.game.newTriangleObject({ points: a.points }))
                : "AnimationObject" === a.type && (b = A.game.newAnimationObject({ animation: a.anim }));
            return b;
        },
        Sb = {},
        Pc = 0,
    ...
    var Qc = 0;
    ya.prototype.getAnimation = function (a, b, c, f, d) {
        ...
        e.prototype = {
            onContext: function (a) {
                this.image.loaded ? a(this.image.context, this.w, this.h, this.r) : this.image.toLoad.push({ w: this.w, h: this.h, r: this.r, func: a });
            },
            getImage: function () {
                return this.image;
            },
    ...
    this.brush.drawTriangleS = function (a) {
        ...
        Ua(g.x + a.x, g.y + a.y, [e(a.w / 2, 0), e(a.w, a.h), e(0, a.h)], a.fillColor, a.strokeColor, a.strokeWidth);
    };
    ...
    this.brush.drawTextS = function (a) {
        wa(e((a.x || 0) + g.x, (a.y || 0) + g.y), a.text, a.color || t.fillStyle, a.size || 10, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
    };
    ...
    this.brush.drawTextLinesS = function (a) {
        if (a.lines) {
            ...
            for (b = 0; b < a.lines.length; b += 1)
                wa(e((a.x || 0) + g.x, (a.y || 0) + g.y + c * b * a.lineHeight), a.lines[b], a.color || t.fillStyle, c, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
        }
    };
    ...
    this.brush.drawRoundRect = function (a) {
        V(a);
        if (a.x + a.w < g.x || a.x > g.x + m || a.y + a.h < g.y || a.y > g.y + n) return !1;
        wb(e(a.x, a.y), z(a.w, a.h), a.radius || 2, a.fillColor || !1, a.strokeColor || t.strokeStyle, a.strokeWidth || !1);
    };
    ...
    this.brush.drawImageS = function (a) {
        if (a.file)
            if (w(p[a.file])) {
                ...
                (p[a.file] = { loaded: !1 }),
                    (b = k.document.createElement("img")),
                    (b.onload = function () {
                        p[a.file].loaded = !0;
                        p[a.file].img = this;
    ...
    var W = k.AudioContext || k.webkitAudioContext || !1;
    ...
    var ia = function (a, b) {
        var c,
            d = k.document.createElement("audio");
        if ("string" == typeof a) {
    ...
    var Rc = function (a) {
        ...
        zc = function (a, b, c) {
            ...
            this.draw = function (a) {
                this.backgroundColor && A.game.fill(this.backgroundColor);
                v(d, function (b) {
                    a && a(b);
                    b.isInCamera() && b.draw();
                });
    ...
    this.system.initFPSCheck = function () {
        Cc ||
            ((Cc = !0),
            l.addEvent("postLoop", "fpsCheckUpdate", function () {
                Ub += 1;
    ...
    d.keyMoveInit = function (a, b, c, e, g, h) {
        ...
        if (h) a(h) && (d.key.keyMoveDY = d.key.SPEED || 1);
    ...
    d.keyMoveCollision = function (a) {
        ...
        a.isStaticIntersect(d.key.NAME.getStaticBoxW(0, -d.key.SPEED, 0, d.key.SPEED)) && d.key.keyMoveDY == -d.key.SPEED && ((d.key.keyMoveDY = 0), (d.key.NAME.y = a.y + a.h));
    ...
    d.mouseMoveInit = function (a, b, c, e) {
        ...
        if (1 == d.mouse.TYPE || 2 == d.mouse.TYPE)
            (d.mouse.POINT = d.mouse.getPosition),
                d.mouse.getPosition.x > d.mouse.NAME.getPositionC().x
                    ? ((d.mouse.mouseMoveDX = d.mouse.SPEED), (d.mouse.mouseX = 1))
                    : d.mouse.getPosition.x < d.mouse.NAME.getPositionC().x && ((d.mouse.mouseMoveDX = -d.mouse.SPEED), (d.mouse.mouseX = 1)),
                d.mouse.getPosition.y < d.mouse.NAME.getPositionC().y
                    ? ((d.mouse.mouseMoveDY = -d.mouse.SPEED), (d.mouse.mouseY = 1))
                    : d.mouse.getPosition.y > d.mouse.NAME.getPositionC().y && ((d.mouse.mouseMoveDY = d.mouse.SPEED), (d.mouse.mouseY = 1));
        if (3 == d.mouse.TYPE || 4 == d.mouse.TYPE || 5 == d.mouse.TYPE)
            a.isPress("LEFT") &&
                ...
                d.mouse.getPosition.y < d.mouse.NAME.getPositionC().y
                    ? ((d.mouse.mouseMoveDY = -d.mouse.SPEED), (d.mouse.mouseY = 1))
                    : d.mouse.getPosition.y > d.mouse.NAME.getPositionC().y && ((d.mouse.mouseMoveDY = d.mouse.SPEED), (d.mouse.mouseY = 1))),
                5 == d.mouse.TYPE && (0 == d.mouse.FLAG1 && 0 == d.mouse.mouseX ? (d.mouse.mouseX = 1) : 0 == d.mouse.FLAG2 && 0 == d.mouse.mouseY && (d.mouse.mouseY = 1));
    };
    d.mouseMoveCollision = function (a) {
        a.isStaticIntersect(d.mouse.NAME.getStaticBoxD(0, 0, d.mouse.SPEED)) &&
            1 == d.mouse.mouseX &&
            d.mouse.mouseMoveDX == d.mouse.SPEED &&
            ((d.mouse.FLAG1 = !0), (d.mouse.mouseX = 0), 2 == d.mouse.TYPE && (d.mouse.mouseY = 0), (d.mouse.NAME.x = a.x - d.mouse.NAME.w), 4 == d.mouse.TYPE && (d.mouse.POINT = 0));
        a.isStaticIntersect(d.mouse.NAME.getStaticBoxA(-d.mouse.SPEED, 0, d.mouse.SPEED)) &&
            1 == d.mouse.mouseX &&
            d.mouse.mouseMoveDX == -d.mouse.SPEED &&
            ((d.mouse.FLAG1 = !0), (d.mouse.mouseX = 0), 2 == d.mouse.TYPE && (d.mouse.mouseY = 0), (d.mouse.NAME.x = a.x + a.w), 4 == d.mouse.TYPE && (d.mouse.POINT = 0));
        a.isStaticIntersect(d.mouse.NAME.getStaticBoxW(0, -d.mouse.SPEED, 0, d.mouse.SPEED)) &&
            1 == d.mouse.mouseY &&
            d.mouse.mouseMoveDY == -d.mouse.SPEED &&
            ((d.mouse.FLAG2 = !0), (d.mouse.mouseY = 0), 2 == d.mouse.TYPE && (d.mouse.mouseX = 0), (d.mouse.NAME.y = a.y + a.h), 4 == d.mouse.TYPE && (d.mouse.POINT = 0));
        a.isStaticIntersect(d.mouse.NAME.getStaticBoxS(0, 0, 0, d.mouse.SPEED)) &&
            1 == d.mouse.mouseY &&
            d.mouse.mouseMoveDY == d.mouse.SPEED &&
            ((d.mouse.FLAG2 = !0), (d.mouse.mouseY = 0), 2 == d.mouse.TYPE && (d.mouse.mouseX = 0), (d.mouse.NAME.y = a.y - d.mouse.NAME.h), 4 == d.mouse.TYPE && (d.mouse.POINT = 0));
    };
    d.mouseMove = function () {
        d.mouse.NAME.getDistanceC(d.mouse.POINT) > d.mouse.SPEED + 1 && d.mouse.NAME.moveToC(d.mouse.POINT, d.mouse.SPEED * d.mouse.mouseX, d.mouse.SPEED * d.mouse.mouseY);
    };
    d.bgCycle = function (a, b, c, d, e) {
        var f = pjs.vector.point;
        if (0 != b) var g = game.newImageObject({ x: 0 > b ? a.x + a.w + b + (d || 0) : a.x - a.w + b + (d || 0), y: a.y, file: a.file });
        if (0 != c) var h = game.newImageObject({ x: a.x, y: 0 > c ? a.y + a.h + c + (e || 0) : a.y - a.h + c + (e || 0), file: a.file });
    ...
    d.physicsMoveInit = function (a, b, c, e, g, h, k, l, m, n, p, q, r, t) {
        ...
        (a(r[0]) || a(r[1]) || a(r[2]) || a(r[3]) || a(r[4]) || a(r[5]) || h(t[0]) || h(t[1]) || h(t[2])) &&
            0 == d.physics.flag1 &&
            ((d.physics.GG = c), (d.physics.BOUNCE = g), (d.physics.memoryDY = 0), (d.physics.keyMoveDY = 0), (d.physics.flag1 = !0));
    ...
    d.physicsMoveCollision = function (a) {
        0 > d.physics.GG &&
            a.isStaticIntersect(d.physics.NAME.getStaticBoxS(0, -d.physics.keyMoveDY + 1, 0, 0)) &&
            ((d.physics.NAME.y = a.y - d.physics.NAME.h),
            (d.physics.m = Math.abs(d.physics.GG)),
            (d.physics.keyMoveDY = 0),
            (d.physics.GG = 0),
            0 != d.physics.BOUNCE && d.physics.m > d.physics.minBounce && (d.physics.GG = d.physics.m / d.physics.BOUNCE),
            0 == d.physics.GG && 0 == d.physics.keyMoveDY && 1 == d.physics.flag1 && ((d.physics.memoryDY = d.physics.NAME.y), (d.physics.flag1 = !1)),
            0 == d.physics.flag1 && (d.physics.GG = d.physics.ACCELETARIONDOWN));
        0 < d.physics.GG &&
            a.isStaticIntersect(d.physics.NAME.getStaticBoxW(0, -d.physics.keyMoveDY, 1, d.physics.ACCELETARIONDOWN)) &&
            ((d.physics.NAME.y = a.y + a.h), (d.physics.GG = 0), 0 != d.physics.STICKING && (d.physics.keyMoveDY = d.physics.STICKING));
        a.isStaticIntersect(d.physics.NAME.getStaticBoxA(d.physics.keyMoveDX, 0, -d.physics.keyMoveDX, 0)) && d.physics.keyMoveDX == -d.physics.SPEED
            ? ((d.physics.keyMoveDX = 0), (d.physics.NAME.x = a.x + a.w), 1 == d.physics.rtStop && (d.physics.ROTATION = 0))
            : a.isStaticIntersect(d.physics.NAME.getStaticBoxD(0, 0, d.physics.keyMoveDX, d.physics.ACCELETARIONDOWN)) &&
              d.physics.keyMoveDX == d.physics.SPEED &&
              ((d.physics.keyMoveDX = 0), (d.physics.NAME.x = a.x - d.physics.NAME.w), 1 == d.physics.rtStop && (d.physics.ROTATION = 0));
    };
    d.physicsMove = function () {
        ...
        0 != d.physics.memoryDY && d.physics.NAME.y > d.physics.memoryDY && 0 == d.physics.flag1 && ((d.physics.memoryDY = 0), (d.physics.flag1 = !0));
    };
